document.addEventListener('DOMContentLoaded', function() {
    ...
    const observer = new IntersectionObserver((entries, observer) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                // Stop observing once the element is trigger
    ...
    if (terminalContainer && terminalContent && commandSpan) {
        const commandText = " https://github.com/Jilofish";
        ...
        if (terminal) {
            ...
            const typeCommand = () => {
                if (i < commandText.length){
                    ...
                    // aAdd blinking cursor effect after typing
                    terminal.querySelector('.command').insertAdjacentHTML('afterend', '<span class="animate-blink"></span>')
                }
            };
